	...
	<?php echo $this->Form->create($model); ?>
		<fieldset>
			...
			<?php
				...
				echo $this->Form->input('UserDetail.street_address');
				echo $this->Form->input('UserDetail.area');
				echo $this->Form->input('UserDetail.town_or_city');
				echo $this->Form->input('UserDetail.postcode');
			?>
			<p>
