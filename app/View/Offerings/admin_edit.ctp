...
<?php echo $this->Form->create('Offering'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Offering'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Offering.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Offering.id'))); ?></li>
